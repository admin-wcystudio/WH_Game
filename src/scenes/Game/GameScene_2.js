...
export class GameScene_2 extends BaseGameScene {
    ...
    preload() {
        ...
        this.load.image('game2_npc_box_mainstreet_01', `${path}game2_npc_box2.png`);
        this.load.image('game2_npc_box_win', `${path}game2_npc_box3.png`);
        this.load.image('game2_npc_box_win_01', `${path}game2_npc_box4.png`);
        ...
        this.load.image(`game2_successobject1`, `${path}game2_successobject1.png`);
        this.load.image(`game2_successobject2`, `${path}game2_successobject2.png`);
    ...
    showLose() {
        ...
        VoiceOverHelper.playBubbleVo(this, 'game2_npc_box_tryagain_02');
    ...
    spawnSuccessItem() {
        const keys = [
            'game2_successobject1',
            'game2_successobject2',
        ];
        // Shuffle the keys array
        Phaser.Utils.Array.Shuffle(keys);
        // Pick a random key from the shuffled array
